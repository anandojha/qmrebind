...
help improve our understanding of drug discovery and development. Accurate 
computational prediction of kinetic rates or residence times of an 
intermolecular encounter can help us identify lead drugs. Kinetic binding 
parameters are often correlated with efficacy rather than binding 
...
and k\ :sub:`off`\), in addition to binding free energy, is extremely 
...
This tool, called “Simulation Enabled Estimation of Kinetic Rates” (SEEKR), 
